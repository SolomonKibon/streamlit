...
selected_species = st.multiselect("Select species to display:", iris_data["species"].unique())
...
selected_feature = st.selectbox("Select a feature to display its distribution:", iris_data.columns[:-1])
